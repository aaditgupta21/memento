...
const faqItems = [
  {
    ...
    answer:
      "You can delete the photo from your Gallery at any time, or replace it when editing a scrapbook.",
  },
  {
    question: "Do my photos keep their original quality?",
    answer:
      "Yes. Memento stores photos in high quality so your memories stay crisp and clear.",
  },
  {
    question: "How does the Wrapped feature work?",
    answer:
      "Wrapped automatically analyzes your uploads, dates, and tags to generate personalized yearly stats.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "No, deleted posts are permanently removed to protect your privacy and storage space.",
  },
  {
    question: "Why can't I upload more than 10 photos at once?",
    answer:
      "To keep uploads fast and avoid server issues, posts are limited to 10 photos each.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Tags help you search, filter, and organize your photos more easily in your gallery.",
  },
];
...
const postSteps = [
  ...
  },
  {
    ...
    detail: "Order them to tell the story the way you remember it.",
    imageSrc: "/upload.png",
    alt: "Upload photos",
  },
  {
